...
三種模式（表單依模式動態生成）：
- 🧸 小小孩・可愛風、🚀 大小孩・酷炫奇幻 — 填空→AI 擴寫中英雙版生圖提示詞（選項性別均衡）。
- 🎬 大人・電影創作 — 專業電影前期工具：logline／類型／時空背景／場景／人設／景別／機位／運鏡／鏡頭焦段／光線／色調／敘事角度／氛圍 → 產出可當分鏡 keyframe 的中英 cinematic 提示詞＋3～5 顆分鏡序列（可再丟 Luma/可靈生成影片）。
